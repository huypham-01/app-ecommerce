...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case productDetailsScreenRoute:
      return MaterialPageRoute(
        builder: (context) {
          ...
          bool isProductAvailable = args['isProductAvailable'] as bool? ?? true;
    ...
    case shippingMethodScreenRoute:
      return MaterialPageRoute(
        builder: (context) => const ShippingMethodScreen(),
      );
    case orderStatusScreenRoute:
      return MaterialPageRoute(
        builder: (context) => const OrderStatusScreen(),
      );
    case ordersCussessScreenRoute:
      return MaterialPageRoute(
        builder: (context) => const OrderSuccessScreen(),
      );
    case bankTransferScreenRoute:
      return MaterialPageRoute(
