...
export '/screens/address/views/addnewaddresses_screen.dart';
// export '/screens/address/views/selectaddresses_screen.dart';
export '/screens/checkout/views/cart_screen.dart';
export '/screens/checkout/views/bankTransfer_Screen.dart';
export '/screens/shipping/shipping_screen.dart';
export '/screens/checkout/views/pay_screen.dart';
export '/screens/checkout/views/order_success.dart';
