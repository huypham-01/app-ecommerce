...
class _OnBordingScreenState extends State<OnBordingScreen> {
  ...
  final List<Onbord> _onbordData = [
    Onbord(
      ...
      title: "Tìm mặt hàng \nbạn đang tìm kiếm",
      description:
          "Ở đây bạn sẽ thấy nhiều loại hàng hóa phong phú, được phân loại cẩn thận để có trải nghiệm liền mạch.",
    ),
    Onbord(
      image: "assets/Illustration/Illustration-1.png",
      imageDarkTheme: "assets/Illustration/Illustration_darkTheme_1.png",
      title: "Lấp đầy giỏ hàng của mình",
      description:
          "Thêm bất kỳ mặt hàng nào bạn muốn vào giỏ hàng của mình hoặc lưu nó vào danh sách yêu thích của bạn để bạn không bỏ lỡ nó trong các giao dịch mua trong tương lai.",
    ),
    Onbord(
