    ...
    <div class="card-body">
      <form method="post" action="{{route('category.store')}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Nhập tiêu đề sản phẩm"  value="{{old('title')}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          <label for="is_parent">Danh mục lớn</label><br>
