...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('users.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Tạo tài khoản</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($users as $user)   
                <tr>
                    ...
                    <td>
                        @if($user->photo)
                            <img src="{{$user->photo}}" class="img-fluid rounded-circle" style="width:60px; height:60px" alt="{{$user->photo}}">
                        @else
                            <img src="{{asset('backend/img/avatar.png')}}" class="img-fluid rounded-circle" style="max-width:60px" alt="avatar.png">
                        @endif
                    </td>
                    ...
                    <td>
                        ...
                        @else
                            <span class="badge badge-warning">Huỷ kích hoạt</span>
                        @endif
                    </td>
                    <td>
