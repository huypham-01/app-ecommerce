      ...
      <form method="post" action="{{route('coupon.update',$coupon->id)}}">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
              ...
              <select name="type" class="form-control">
                  <option value="fixed" {{(($coupon->type=='fixed') ? 'selected' : '')}}>VNĐ </option>
          ...
          <div class="form-group">
              ...
              <input id="inputTitle" type="number" name="value" placeholder="Nhập giá trị của mã giảm giá"  value="{{$coupon->value}}" class="form-control">
              @error('value')
              <span class="text-danger">{{$message}}</span>
              @enderror
          </div>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            ...
            <option value="inactive" {{(($coupon->status=='inactive') ? 'selected' : '')}}>Huỷ kích hoạt</option>
          </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
