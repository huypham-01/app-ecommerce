...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('coupon.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Thêm mã</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($coupons as $coupon)   
                <tr>
                    ...
                    <td>
                        @if($coupon->type=='fixed')
                            {{number_format($coupon->value,3)}}VNĐ
                        @else
                            {{$coupon->value}}%
                        @endif</td>
                    <td>
                        ...
                        @else
                            <span class="badge badge-warning">Huỷ kịch hoạt</span>
                        @endif
                    </td>
                    <td>
